<div id="footer">
     ...
     <div class="row">
       ...
       <div class="col-lg-3 col-md-3">
         <a class="footer-link" href="mailto:vvsdcharan2001@gmail.com" target="_blank"> <img class="SM" src="../images/gmail.png" alt="Error Processing Image"> </a>
       </div>
     </div>
     <br>
     <p style="color: grey;"> Copyright 2023 VVSDC</p>
   </div>